...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Marquee ticker — dir=ltr on the wrapper so the strip is left-aligned and
          loops seamlessly (no empty gap) in Arabic just like English */}
      <div dir="ltr" className="absolute bottom-0 left-0 w-full overflow-hidden border-y border-ink-line bg-lime-bright py-2.5 sm:py-3">
